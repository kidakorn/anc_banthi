...
<body class="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen">
                        ...
                        <thead class="sticky top-0 z-20">
                            <tr>
                                ...
                                $headers = [
                                    ...
                                    ['label' => 'วันที่ที่มาฝากครรภ์ครั้งแรก', 'icon' => 'fa-calendar-plus', 'width' => '180px'],
                                    ['label' => 'ชื่อ-สกุล', 'icon' => 'fa-user', 'width' => '200px'],
                                    ['label' => 'เบอร์โทร', 'icon' => 'fa-phone', 'width' => '120px'], // <-- เพิ่มฟิลด์เบอร์โทร
                                    ...
                                    <tr class="hover:bg-blue-100/60 even:bg-white/90 transition-all duration-150 group">
                                        ...
                                        <td class="py-3 px-4 border text-center">
                                            <div class="flex flex-col gap-2 justify-center items-center">
                                                <button class="text-red-600 hover:text-white hover:bg-red-500 border border-red-400 rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-150 deleteData shadow group-hover:scale-105 flex items-center gap-2 w-32"
                            ...
                            <div class="bg-gradient-to-br from-purple-50/80 via-white to-violet-100 rounded-2xl shadow p-8 border border-purple-200/40 hover:border-purple-400 transition mt-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    <div class="md:col-span-3 col-span-1">
                                        <label class="block text-gray-700 font-semibold mb-2">LAP Alert</label>
                                        <textarea
                                            id="add-lap_alert"
                                            name="lap_alert"
                        ...
                        <div class="space-y-10">
                            ...
                            <div class="bg-gradient-to-br from-blue-50/80 via-white to-blue-100 rounded-2xl shadow p-8 border border-blue-200/40 hover:border-blue-400 transition">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">HN</label>
                                        <input type="text" id="modal-hn" name="hn" class="w-full px-3 py-2 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-400">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">วันที่ที่มาฝากครรภ์ครั้งแรก</label>
            ...
            <div class="bg-white/90 rounded-3xl shadow-2xl w-11/12 max-w-7xl mx-auto mb-8 border border-yellow-200/40">
                ...
                <div class="p-10 space-y-10">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-xl p-3 shadow flex flex-col">
                            <h4 class="text-sm font-bold text-red-700 mb-2 flex items-center gap-1">
                                <i class="fas fa-heartbeat text-red-500"></i> อายุรกรรม
                            </h4>
    ...
    <footer class="py-4">
        <div class="container mx-auto text-center">
            <p class="text-gray-600">© 2025 ระบบติดตามการฝากครรภ์ | สำนักงานสาธารณสุขอำเภอบ้านธิ จังหวัดลำพูน</p>
        </div>
    </footer>
